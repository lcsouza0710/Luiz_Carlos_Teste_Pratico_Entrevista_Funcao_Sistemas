...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CEP", cliente.CEP.Trim().Replace("-", "")));
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("Telefone", cliente.Telefone.Trim().Replace("-", "").Replace("(", "").Replace(")", "")));
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", cliente.CPF.Trim().Replace(".", "").Replace("-", "")));
